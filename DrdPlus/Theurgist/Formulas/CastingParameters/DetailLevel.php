...
class DetailLevel extends CastingParameter implements PositiveInteger
{
    /**
     * @var int
     */
    ...
    /**
     * @param array $values
     * @throws \DrdPlus\Theurgist\Formulas\CastingParameters\Exceptions\InvalidValueForDetailLevel
    ...
    public function __construct(array $values)
    {
        try {
            ...
            throw new Exceptions\InvalidValueForDetailLevel(
                'Expected positive integer for detail level, got '
