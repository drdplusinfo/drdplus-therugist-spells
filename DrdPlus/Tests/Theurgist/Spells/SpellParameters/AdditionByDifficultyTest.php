...
class AdditionByDifficultyTest extends TestWithMockery
{
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Theurgist\Spells\SpellParameters\Exceptions\InvalidFormatOfDifficultyIncrement
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Theurgist\Spells\SpellParameters\Exceptions\InvalidFormatOfAdditionByDifficultyValue
