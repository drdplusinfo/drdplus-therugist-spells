...
class FormulaDifficultyAdditionTest extends TestWithMockery
{
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Theurgist\Spells\SpellParameters\Exceptions\InvalidFormatOfAdditionByRealmsNotation
     */
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Theurgist\Spells\SpellParameters\Exceptions\InvalidFormatOfRealmsIncrement
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Theurgist\Spells\SpellParameters\Exceptions\InvalidFormatOfAdditionByRealmsValue
