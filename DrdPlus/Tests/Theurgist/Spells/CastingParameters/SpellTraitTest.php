...
class SpellTraitTest extends TestWithMockery
{
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Theurgist\Spells\CastingParameters\Exceptions\InvalidValueForSpellTraitDifficultyChange
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Theurgist\Spells\CastingParameters\Exceptions\UnexpectedFormatOfSpellTrait
