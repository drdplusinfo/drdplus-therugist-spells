...
class AdditionByDifficultyTest extends TestWithMockery
{
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Theurgist\Spells\CastingParameters\Exceptions\InvalidFormatOfAdditionByDifficultyNotation
     */
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Theurgist\Spells\CastingParameters\Exceptions\InvalidFormatOfDifficultyIncrement
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Theurgist\Spells\CastingParameters\Exceptions\InvalidFormatOfAdditionByDifficultyValue
